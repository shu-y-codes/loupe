...
it does not show which files landed. [11-readme-walkthrough.md](11-readme-walkthrough.md)
describes what a reviewer sees — write that after this chrome exists, not against today's
widget. [10-reviewer-chrome.md](10-reviewer-chrome.md) groups the file list this slice
adds; do not reopen this slice for that grouping.
...
[11-readme-walkthrough.md](11-readme-walkthrough.md).
